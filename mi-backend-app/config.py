...
URL_NGROK_OFERTAS = os.getenv("URL_NGROK_OFERTAS", "")
URL_NGROK_CONTACTO = os.getenv ("URL_NGROK_CONTACTO","")
...
ENTORNO_COMPLETO = "PRODUCCION" # Puede ser PRODUCCION O DESARROLLO 1,2,3,...16
